...
public class MyTasksRegist implements Initializable{
	...
	private MyTasksRegist(Window prarentWindow) {
	...
	public static MyTasksRecord showAndGetMtData(Window parentWindow) {
		MyTasksRegist hoge = new MyTasksRegist(parentWindow);
		return hoge.getResult();
	}

	/**データ編集モード**/
	public static MyTasksRecord showAndEditMtData() {
		MyTasksRegist hoge = new MyTasksRegist(null);
		return hoge.getResult();
	}
